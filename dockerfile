FROM ubuntu:18.04
MAINTAINER Mingqiang <chenmingqiang@airdoc.com>
...
# Install
RUN apt-get -y install wget curl git unzip supervisor g++ make nginx mysql-server mysql-client redis-server #php5-cli php5-fpm php5-dev php5-mysql php5-curl php5-intl php5-mcrypt php5-memcache php5-imap php5-sqlite
